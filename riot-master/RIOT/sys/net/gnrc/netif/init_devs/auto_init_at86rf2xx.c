...
void auto_init_at86rf2xx(void)
{
    for (unsigned i = 0; i < AT86RF2XX_NUM; i++) {
        ...
        DEBUG("[auto_init_netif] initializing at86rf2xx #%u\n", i);
        ...
        gnrc_netif_lwmac_create(&_netif[i], _at86rf2xx_stacks[i],
                                ...
                                &at86rf2xx_devs[i].netdev.netdev);
#elif defined(MODULE_GNRC_WAYE)
        gnrc_netif_waye_create(&_netif[i], _at86rf2xx_stacks[i],
                                AT86RF2XX_MAC_STACKSIZE,
                                AT86RF2XX_MAC_PRIO, "at86rf2xx-waye",
                                &at86rf2xx_devs[i].netdev.netdev);
#else
